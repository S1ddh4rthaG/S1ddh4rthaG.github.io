  ...
  <div class="col-12">
    <div class="card mb-4 shadow-sm">
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-start mb-1">
          <h5 class="card-title mb-0">
            LLM2FedLLM - A Tool for Simulating Federated LLMs for Software
            Engineering Tasks
          </h5>
        </div>
        <h6 class="text-muted">
          Jahnavi Kumar, <strong>Siddhartha Gandu</strong>, Sridhar Chimalakonda
        </h6>
        <p class="card-text text-small">
          <em
            >2025 IEEE/ACM 33rd International Conference on Program
            Comprehension (ICPC)</em
          ><br />
          <strong>DOI:</strong> 10.1109/ICPC66645.2025.00052
          <br />
          <a href="https://doi.org/10.1109/ICPC66645.2025.00052" target="_blank">IEEE Xplore</a>
        </p>
      </div>
    </div>
  </div>
  ...
  <div class="col-12">
    ...
    <div class="card mb-4 shadow-sm">
      <div class="card-body">
        ...
        <span class="badge" style="font-size: 0.93em;">2020 – 2024</span>
        </div>
        <h6 class="text-muted">
    ...
    <div class="card mb-4 shadow-sm">
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-start mb-3">
          <div>
            <h5 class="card-title mb-1"><a href="/_projects/botanixcraft" target="_blank">SpiderHack 2024 - BotanixCraft</a></h5>
            <h6 class="mb-2">Third Prize and Most Creative Award</h6>
          </div>
        </div>
  ...
  <div class="col-12">
    <div class="card mb-4 shadow-sm">
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-start mb-3">
          <div>
            <h5 class="card-title mb-0"><a href="/_projects/bnbcraft" target="_blank">BNBChain Hackathon - BNBCraft</a></h5>
            <h6 class="mb-2">Potential Award Winner</h6>
          </div>
        </div>
        <p class="card-text text-muted">
  ...
  <div class="col-12">
    <div class="card mb-4 shadow-sm">
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-start mb-3">
          <div>
            <h5 class="card-title mb-0"><a href="/_projects/areonmart" target="_blank">CodeAREA Hackathon - AreonMart</a></h5>
            <h6 class="mb-2">Winner</h6>
          </div>
        </div>
        <p class="card-text text-muted">
